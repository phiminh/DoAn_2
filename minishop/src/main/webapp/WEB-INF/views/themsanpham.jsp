...
<div class="left-content ">
	...
	<form id="form-sanpham" action="" >
		<div class="col-md-5 col-sm-12 form-group">
			...
			<input type="text" name="giatien" id="giatien" class="form-control" placeholder ="Nhap vao gia tien"/></br>
			...
			<label class="radio-inline">
				<input type="radio" id="rd-nu" name="gianhcho" value="Nữ">Nữ
			</label></br>
			...
			<textarea rows="5" type="text" name="mota" id="mota" class="form-control" placeholder ="Nhap vao mo ta"></textarea></br>
			...
			<!-- <p><button id="btnThemSanPham" class="btn btn-primary">Thêm sản phẩm</button></p> -->
			<p>
			
			<input id="btnThemSanPham" class="btn btn-primary" type="submit" value="Thêm sản phẩm" />
			<input id="btnCapNhatSanPham" class="btn btn-primary hidden" type="submit" value="Cập nhật" />
			<!-- <input id="btnThoat" class="btn btn-primary hidden" type="submit" value="Thoát" /> -->
                           ...
                           <div class="menu">
									<ul id="menu" >
										<li><a href="index.html"><i class="fa fa-tachometer"></i> <span>Dashboard</span><div class="clearfix"></div></a></li>
										 ...
										 <li id="menu-academico" ><a href="inbox.html"><i class="fa fa-cube nav_icon" aria-hidden="true"></i><span>SẢN PHẨM</span><div class="clearfix"></div></a></li>
